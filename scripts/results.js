...
window.addEventListener('load', function (event) {
    ...
    var datastore = new firebasedatastore('http://personality-quiz-6bc17.firebaseapp.com');
    ...
    elementForm.addEventListener('submit', function (event) {
        ...
        // If user_name is not empty, save the data to the DB 
        if(user_name !== '') {
            var data = { 
                name: user_name, 
